    ...
    return(
        <form onSubmit={handleSubmit} className="dark:border-white text-black text-center text-bold text-lg border-black mx-auto p-10 border-3 rounded-md bg-blue-300">
            ...
            <label className="flex flex-row gap-2">
              Name:
              <input type="text" name="Name:"value={name} onChange={(e) => setName(e.target.value)} required = {true} className="bg-blue-50 border-2 border-black p-0.5 w-full rounded-md text-black" />
            </label>   
